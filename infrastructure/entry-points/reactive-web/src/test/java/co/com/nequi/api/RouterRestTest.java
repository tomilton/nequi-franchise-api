...
class RouterRestTest {
    ...
    void testCreateSucursal_ShouldReturnSuccess() {
        ...
        Sucursal sucursal = Sucursal.builder()
                ...
                .name("Test Sucursal")
                .build();
        when(sucursalUseCase.save(any(Sucursal.class)))
    ...
    void testCreateProduct_ShouldReturnSuccess() {
        ...
        Product product = Product.builder()
                ...
                .stock(100)
                .build();
        when(productUseCase.save(any(Product.class)))
    ...
    void testDeleteProduct_ShouldReturnSuccess() {
        // Arrange
        when(productUseCase.delete(anyInt(), anyInt()))
    ...
    void testUpdateSucursalName_ShouldReturnSuccess() {
        ...
        Sucursal updatedSucursal = Sucursal.builder()
                .franchiseId(1)
                .name("Updated Sucursal")
                .build();
        when(sucursalUseCase.updateName(anyInt(), anyString()))
    ...
    void testUpdateProductName_ShouldReturnSuccess() {
        ...
        Product updatedProduct = Product.builder()
                ...
                .stock(100)
                .build();
        when(productUseCase.updateName(anyInt(), anyString()))
                .thenReturn(Mono.just(updatedProduct));
